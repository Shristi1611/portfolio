window.onload = () => {
    ...
    const texts = ["Software Engineer 🎀", "ML & CV Enthusiast", "Java Developer"];
...
if(feedbackForm) {
    feedbackForm.addEventListener('submit', function(e) {
        ...
        if (name && email) {
            const entry = { name, email, msg: document.getElementById('userMessage').value, date: new Date().toLocaleString() };
